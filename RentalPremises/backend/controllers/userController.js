...
module.exports = {
    async editUser(req, res) {
        try {
            ...
            await usersDb.editUserByLogin(req.body.login, req.body.name, req.body.surname, req.body.phoneNumber);
    ...
    async editUserById(req, res) {
        try {
            ...
            if(user && user.ID !== parseInt(req.body.id)) return res.status(409).send();

            await usersDb.editUserById(parseInt(req.body.id), req.body.login, req.body.password, parseInt(req.body.role), req.body.name, req.body.surname, req.body.phoneNumber);
    ...
    async addUser(req, res) {
        try {
            ...
            await usersDb.createUser(req.body.login, req.body.password, parseInt(req.body.role), req.body.name, req.body.surname, req.body.phoneNumber);
